...
$stmt = $db->prepare("SELECT SetID FROM Plays WHERE Vote10!= -1 ORDER BY Rand() LIMIT 1;");
$stmt->execute();
$row = $stmt->fetch(PDO::FETCH_ASSOC);
$setid = $row['SetID'];
$_SESSION['setid']=$setid;
//DEBUG
//echo "method tut set $setid ";
...
<head>
  ...
  <script type="text/javascript" src="js/tab_tutorial.js"></script>
